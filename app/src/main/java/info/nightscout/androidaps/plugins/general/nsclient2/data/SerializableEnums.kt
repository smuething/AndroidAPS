...
// TODO: as some part of it is used for AAPS UI and not  NightScout only, split or refactor out of plugin space

enum class TrendArrowNightScout(val text: String, val symbol: String) {
...
enum class SourceSensorNightScout(val text: String) {
