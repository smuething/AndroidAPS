...
class PreferenceProvider<T : Any> constructor(val preference: String, val defaultValue : T, val sp: SP) {

    constructor(@StringRes resId: Int, defaultValue: T, sp: SP, resourceHelper: ResourceHelper)
        : this(resourceHelper.gs(resId), defaultValue, sp)
