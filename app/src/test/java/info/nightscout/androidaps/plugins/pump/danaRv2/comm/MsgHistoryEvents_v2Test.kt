...
class MsgHistoryEvents_v2Test : DanaRTestBase() {
    ...
    @Test @Throws(Exception::class) fun runTest() {
        val packet = MsgHistoryEvents_v2(aapsLogger, resourceHelper, detailedBolusInfoStorage, danaRv2Plugin, RxBusWrapper(aapsSchedulers), treatmentsPlugin, injector, 0)
