...
class MsgInitConnStatusTimeTest : DanaRTestBase() {
    ...
    @Test fun runTest() {
        val packet = MsgInitConnStatusTime(aapsLogger, RxBusWrapper(aapsSchedulers), resourceHelper, danaRPump, danaRPlugin, danaRKoreanPlugin, configBuilderPlugin, commandQueue)
